    ...
    <div className="fixed inset-0 z-30 flex items-start justify-center bg-black/30 p-4 pt-16 whitespace-normal text-left">
      <div className="card w-full max-w-lg p-0">
        <div className="flex items-center justify-between border-b border-line px-5 py-3">
          <h2 className="font-semibold text-heading">{editing ? "Edit Assignment" : "New Job Assignment"}</h2>
        ...
        <form
          onSubmit={async (e) => {
            ...
            const fd = new FormData(form); editing ? await updateJob(fd) : await createJob(fd); setOpen(false); }}
