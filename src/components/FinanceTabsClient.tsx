...
import { LayoutGrid, BookOpen, ScrollText, FileBarChart, Receipt, RefreshCw, Users, Clock, HardHat, Building2, Scale, Banknote, Lock, Landmark, Percent, Settings2 } from "lucide-react";
...
const TABS = [
  ...
  { href: "/finance/settings", label: "Settings", icon: Settings2, screen: "finance.settings" },
];
