...
import { Users, ClipboardList, UserPlus, Wallet, CalendarDays, CalendarCheck, BadgeCheck, ShieldAlert, UserMinus, Scale } from "lucide-react";
...
const TABS = [
  ...
  { href: "/hr/policy", label: "HR Policy", icon: Scale, screen: "hr.policy" },
