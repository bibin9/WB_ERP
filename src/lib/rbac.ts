...
export const SCREENS: ScreenDef[] = [
  ...
  { key: "finance.einvoicing", module: "finance", label: "Electronic Invoicing", href: "/finance/einvoicing" },
  { key: "finance.tally", module: "finance", label: "Tally Sync", href: "/finance/tally" },
  { key: "finance.settings", module: "finance", label: "Finance Settings", href: "/finance/settings" },
  ...
  { key: "hr.overtime", module: "hr", label: "Overtime", href: "/hr/overtime" },
  { key: "hr.manhours", module: "hr", label: "Manhours", href: "/hr/manhours" },
  { key: "hr.workforce", module: "hr", label: "Workforce Mix", href: "/hr/workforce" },
  ...
  { key: "inventory.rfq", module: "inventory", label: "Enquiries & Quotes", href: "/inventory/rfq" },
  { key: "inventory.orders", module: "inventory", label: "Purchase Orders", href: "/inventory/orders" },
  { key: "inventory.vendors", module: "inventory", label: "Supplier Performance", href: "/inventory/vendors" },
