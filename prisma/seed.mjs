...
const MODULE_SCREENS = {
  ...
  finance: [
    ...
    "finance.parties", "finance.outstanding", "finance.cashflow", "finance.cheques", "finance.retention", "finance.advances", "finance.bankrec", "finance.jobs", "finance.wip", "finance.costcentres",
  ...
  hse: ["hse.register"],
  audit: ["audit.log"],
  settings: ["settings.general", "settings.master", "settings.approvals", "settings.custom", "settings.email", "settings.documents", "settings.retention"],
};
